...
_MESSAGES: list[tuple[str, str]] = [
    (
        "came back empty — no such symbol",
        "نمادی با این نام پیدا نشد — املای نماد را چک کن. هیچ سفارشی فرستاده نشد.",
    ),
    (
    ...
    (
        ...
        "فایل keypad.html را از گالری همین سفارش (▶ کنار وضعیت) بفرست.",
    ),
    (
        "box would not clear",
...
FALLBACK = "خطای ناشناخته — جزئیات در لاگ سرور و گالری همین سفارش است."
